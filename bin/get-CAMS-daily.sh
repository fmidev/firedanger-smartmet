...
old=$(date -d "$year$month$day 3 months ago" +%Y%m%d)
...
[ -f cams-fc-$year$month${day}-sam.grib ] || /home/users/smartmet/bin/cds-atm-cmp-fc.py $year $month $day &&\
 ...
 rm grib/CAMS_${old}T000000_sfc-daily-fc-sam.grib

[ -f cams-ml-fc-$year$month${day}-sam.grib ] || /home/users/smartmet/bin/cds-cams-ml.py $year $month $day &&\
 mv cams-ml-fc-$year$month${day}-sam.grib grib/CAMS_$year$month${day}T000000_ml-daily-fc-sam.grib # && \
# rm grib/CAMS_${old}T000000_ml-daily-fc-sam.grib	
