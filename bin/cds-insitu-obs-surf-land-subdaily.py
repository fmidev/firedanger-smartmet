...
year=sys.argv[1]
mon=sys.argv[2]
print('/home/users/smartmet/data/Annin/insitu-obs-land-surf_subdaily_eu_%s%s.zip'%(year,mon))
...
c.retrieve(
    ...
    '/home/users/smartmet/data/Annin/insitu-obs-land-surf_subdaily_eu_%s%s.zip'%(year,mon))
